...
void loadSector(uint16_t track, uint16_t head, uint16_t sector, uint32_t addr, uint16_t num);
static inline void loadLogicSector(uint16_t lgsector, uint32_t addr, uint16_t num) {
